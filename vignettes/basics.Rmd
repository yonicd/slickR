...
slickR(obj = nba_player_logo$uri[1:10],height = 100, width = "95%") + 
  settings(dots = TRUE)
...
slickR(obj = nba_player_logo$uri,height = 100, width = "95%") + opts
...
htmltools::browsable(htmltools::tagList(s2, slick_teams))
```
...
slick_up_stack <- slickR(obj = nba_player_logo$uri[1:5], height = 100, width = "95%")

slick_down_stack <- slickR(obj = nba_player_logo$uri[6:10], height = 100, width = "95%")
...
slick_up <- slickR(obj = nba_player_logo$uri,
                objLinks = nba_player_logo$player_home,
                height = 100, width = "95%") + 
  settings(slidesToShow = 1, slidesToScroll = 1)

slick_down <- slickR(obj = nba_player_logo$uri,height = 100, width = "95%") + settings(slidesToScroll = 1, slidesToShow = 5,
...
slickR(obj = nba_player_logo$uri[1:2]) %synch%
